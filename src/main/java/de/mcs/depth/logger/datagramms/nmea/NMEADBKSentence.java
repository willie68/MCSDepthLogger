 ...
 * 
 */
public class NMEADBKSentence extends NMEADepthSentence {
   ...
   * @param lineNumber
   */
  public NMEADBKSentence(long timeStamp, String talkerId, CHANNEL channel, String rawData, int lineNumber) {
