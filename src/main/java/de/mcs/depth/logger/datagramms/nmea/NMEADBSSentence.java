...
/**
 * NMEA Depth below Surface
 * 
 * @author Willie
 * 
 */
public class NMEADBSSentence extends NMEADepthSentence {
   ...
   * @param lineNumber
   */
  public NMEADBSSentence(long timeStamp, String talkerId, CHANNEL channel, String rawData, int lineNumber) {
