...
/**
 * NMEA Depth below Transducer
 * 
 * @author Willie
 * 
 */
public class NMEADBTSentence extends NMEADepthSentence {
   ...
   * @param lineNumber
   */
  public NMEADBTSentence(long timeStamp, String talkerId, CHANNEL channel, String rawData, int lineNumber) {
