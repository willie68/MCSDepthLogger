 ...
 * 
 */
public class NMEAZDASentence extends NMEADatagram {
   ...
   * @param lineNumber
   */
  public NMEAZDASentence(long timeStamp, String talkerId, CHANNEL channel, String rawData, int lineNumber) {
  ...
  public Date getDateTime() {
    ...
    String day = datafields[2];
    String month = datafields[3];
    String year = datafields[4];
    return DateTimeUtils.parseDateTime(String.format("%s%s%s%s", year, month, day, time));
  }
