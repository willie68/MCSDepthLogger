...
public class JXMapKit extends JPanel {
  ...
  public JXMapKit() {
    ...
    try {
      Icon minusIcon = new ImageIcon(getClass().getResource("viewer/resources/minus.png"));
      this.zoomOutButton.setIcon(minusIcon);
      this.zoomOutButton.setText("");
      Icon plusIcon = new ImageIcon(getClass().getResource("viewer/resources/plus.png"));
    ...
    // an overlay for the mini-map which shows a rectangle representing the main
    // map
    miniMap.setOverlayPainter(new Painter<JXMapViewer>() {
      ...
      public void paint(Graphics2D g, JXMapViewer map, int width, int height) {
        ...
        Point2D lowerRight2D = new Point2D.Double(upperLeft2D.getX() + mainMapBounds.getWidth(), upperLeft2D.getY()
  ...
  private void initComponents() {
    ...
    zoomInButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("viewer/resources/plus.png")));
    ...
    zoomOutButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("viewer/resources/minus.png")));
  ...
  /**
   * Indicates if the zoom buttons are visible. This is a bound property and can
   * be listed for using a PropertyChangeListener
   * 
  ...
  /**
   * Sets if the zoom buttons should be visible. This ia bound property. Changes
   * can be listened for using a PropertyChaneListener
   * 
  ...
  private void rebuildMainMapOverlay() {
     ...
     * if(isDataProviderCreditShown()) { ptrs.add(dataProviderCreditPainter); }
     * if(isAddressLocationShown()) { ptrs.add(addressLocationPainter); }
     */
