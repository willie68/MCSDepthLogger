...
public class VirtualEarthTileFactoryInfo extends TileFactoryInfo {
  ...
  public VirtualEarthTileFactoryInfo(MVEMode mode) {
    super("Virtual Earth", MIN_ZOOM_LEVEL, MAX_ZOOM_LEVEL, TOP_ZOOM_LEVEL, TILE_SIZE, false, false, "", null, "", "",
        "");
  ...
  public String getTileUrl(final int x, final int y, final int zoom) {
    ...
    return "http://" + mode.type + quad.charAt(quad.length() - 1) + ".ortho.tiles.virtualearth.net/tiles/" + mode.type
        + quad + mode.ext + "?g=1";
  }
