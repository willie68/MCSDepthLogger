...
public class WMSTileFactoryInfo extends TileFactoryInfo {
  ...
  public WMSTileFactoryInfo(int minZoom, int maxZoom, int totalMapZoom, String baseURL, String layers, String styles,
      String defaultBgColor, String tileFormat, String srs, int tileSize) {
    super(minZoom, maxZoom, totalMapZoom, tileSize, true, true, baseURL, null, "x", "y", "zoom");
    this.layers = layers;
    this.styles = styles;
  ...
  public String getTileUrl(int x, int y, int zoom) {
    ...
    String url = getBaseURL() + "?version=1.1.1&request=GetMap&layers=" + this.getLayers() + "&format="
        + this.getTileFormat() + "&bbox=" + bbox + "&width=" + tileSize + "&height=" + tileSize + "&srs="
        + this.getSrs() + "&styles=" + this.getStyles()
